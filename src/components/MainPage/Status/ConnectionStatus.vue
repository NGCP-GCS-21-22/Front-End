...
export default defineComponent({
  props: {
    status: { required: true, type: String },// String for status of vehicle
    latency: { required: true, type: Number },// Number for current connection latency
  },
});
</script>

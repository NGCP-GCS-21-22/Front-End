  ...
  <div>
    ...
    <b-form-group v-slot="{ ariaDescribedby }">
      <b-form-radio-group
        ...
        buttons
      >
        <b-form-radio :class="keep_in == true ? 'keep-in-selected' : 'toggle'" :value="true"
          >Keep In</b-form-radio
        >
        <b-form-radio :class="keep_in == false ? 'keep-out-selected' : 'toggle'" :value="false"
          ...
          <b-col cols="3">
            <b-row>
              ...
              <b-button
                ...
                v-show="index || (!index && coordinates.length > 1)"
                variant="light"
                size="sm"
                class="btn"
              >
...
export default {
  ...
  methods: {
    ...
    add(index) {
      ...
      newCoordinates.splice(index + 1, 0, { lat: defaultLat, lng: defaultLng });
    ...
    updateGeofenceWorkspace(newCoordinates) {
      ...
      this.$emit("updateWidgetData", "geofenceWorkspace", newGeofenceWorkspace);
    },
  },
};
</script>
